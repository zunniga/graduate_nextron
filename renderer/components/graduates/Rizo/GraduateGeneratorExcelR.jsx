...
import { NewDataRizo } from "../../graduates/Rizo/ImageRizoDB";
import { participantDB } from "../../../components/graduates/Rizo/ReadExcelParticipants";
...
for (var i = 0; i < cantidadModulos; i++) {
  ...
  return (
    <>
      <button
        className="w-full btn text-xl font-futura-bkbt  items-center bg-[#6d0083] text-[#ffff] hover:bg-[#ffd700]/80 mb-5 rounded-lg "
