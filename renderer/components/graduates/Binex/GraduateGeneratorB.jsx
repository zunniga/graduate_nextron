...
import { NewDataBinex } from "../../../components/graduates/Binex/ImageBinexDB"; // Importa la clase ImageDatabase
    ...
    if (
      ...
      Promise.all(certificatesToSave)
        ...
        .then(() => {
          ...
          window.location.href = "/graduates_main/graduate_binex/graduate";
        })
        .catch((error) => {
          console.error(
