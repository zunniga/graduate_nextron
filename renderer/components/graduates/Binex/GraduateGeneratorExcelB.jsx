...
import { NewDataBinex } from "./ImageBinexDB";
import { participantDB } from "../../../components/graduates/Binex/ReadExcelParticipants";
...
const CertificateGeneratorExcel = ({
  ...
  const generateCertificates = async () => {
    try {
      ...
      alert("Diplomados Gernerados exitosamente");
  ...
  return (
    <>
      <button
        className="w-full btn text-xl font-futura-bkbt  items-center bg-[#00dbb8]/60 text-[#fff] hover:bg-gray-500  mb-5 rounded-lg "
