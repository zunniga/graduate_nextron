...
import { NewDataCimade } from "../../graduates/Cimade/ImageCimadeDB"; // Importa la clase ImageDatabase
    ...
    if (
      ...
      Promise.all(certificatesToSave)
        ...
        .then(() => {
          ...
          window.location.href = "/graduates_main/graduate_cimade/graduate/route/page";
        })
        .catch((error) => {
          console.error(
