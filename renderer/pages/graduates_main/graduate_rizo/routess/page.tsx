...
export default function Home({}: HomeProps) {
  ...
  return (
    <main className="relative flex flex-col items-center justify-center h-screen bg-[#1c004c]">
       <IoIosExit
      ...
      <Link href="/graduates_main/graduate_rizo/uploadImages/page">
        <div className="w-48 bg-[#6d0083] border border-white h-12 text-center text-xl text-slate-200 font-futura-bkbt flex justify-center items-center absolute top-0 left-0 m-9 cursor-pointer rounded-xl ml-20">
          Modelo Actual
        </div>
      </Link>
      ...
      <div className="flex justify-center mb-8">
        <img
          src="/images/logos_main/rizo.png"
          alt="logo_ecomas"
      ...
      <div className="flex flex-row">
        {[0, 1].map((index) => (
          <div
            key={index}
            className="flex items-center bg-[#6d0083] text-white font-semibold mr-4 p-4 rounded-xl"
          >
            <div className="mr-2 ">
              {" "}
      ...
      <Link href="/graduates_main/graduate_rizo/graduate/route/page" passHref legacyBehavior>
        <button
          className={`btn bg-[#6d0083] text-slate-200 btn-lg mt-8 ${
