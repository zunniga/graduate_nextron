...
import { useUploader } from "../../../../components/graduates/Rizo/ImageRizoDB";
...
export default function Home() {
  ...
  return (
    <main className="bg-[#1c004c] flex flex-col items-center justify-center h-screen">
      {/* Botón del icono en la esquina superior derecha */}
      <Link href="/graduates_main/graduate_rizo/routess/page">
        <IoIosExit
        ...
        {[0, 1].map((index) => (
          <div key={index} className="mr-10 flex">
            ...
            <label className="form-control w-full max-w-xs">
              <div className="label bg-[#6d0083]/60 rounded-xl">
      ...
      <Link href="/graduates_main/graduate_rizo/routess/page" passHref legacyBehavior>
        <button
          className={`btn text-white bg-[#6d0083] border border-white btn-lg mt-8  ${
