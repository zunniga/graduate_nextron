...
export default function Home() {
  ...
  const handleLogout = () => {
    ...
    window.location.href = "/graduates_main/graduate_rizo/routess/page";
  };
      ...
      <header className="mt-8 text-center mb-10">
        ...
        <ul className="steps w-full">
          ...
          <li className="step step-warning font-extralight text-xl ">
            <Link href="/graduates_main/graduate_rizo/graduate/route/page">Insercion de Participantes </Link>
            <Link href="/graduates_main/graduate_rizo/graduate/route/page" passHref legacyBehavior>
          ...
          <li className="step font-extralight text-xl ">
            <Link href="/graduates_main/graduate_rizo/graduate/graduate_reverso/page">Anverso del Diplomado</Link>
          </li>
          <li className="step font-extralight text-xl">
            <Link href="/" passHref>
              Exportar en PDF
            </Link>
            <Link href="/graduates_main/graduate_rizo/graduate/graduate_reverso/" passHref legacyBehavior>
              <button className=" bg-[#1c004c] text-white btn btn-outline hover:bg-[#ffd700]/90 hover:text-white mt-4">
                Avanzar
                <GrLinkNext size={25} />
              </button>
        ...
        <div className=" flex w-full ">
          ...
          <div className="w-[400px]  text-white mt-24 ml-5  rounded-r-xl ">
            <ul className="p-4  border border-slate-200 rounded-xl">
              <li>
                <button
                  className="w-full  text-xl font-futura-bkbt btn bg-[#6d0083] text-[#ffff] hover:bg-[#ffd700]/80 mb-5"
                  onClick={openModal}
                >
                  Agregar manualmente
              ...
              <li>
                <button
                  className="w-full btn text-xl font-futura-bkbt bg-[#6d0083] text-[#ffff] hover:bg-[#ffd700]/80 mb-5"
