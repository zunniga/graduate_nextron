...
export default function Home() {
  ...
  return (
    <div className="bg-[#1c004c] h-screen overflow-hidden">
      <header className="mt-8 text-center">
        ...
        <ul className="steps w-full">
          ...
          <li className="step step-warning font-extralight text-xl ">
            <Link href="/graduates_main/graduate_rizo/graduate/routess/page">Insercion de Participantes </Link>
            <Link href="/graduates_main/graduate_rizo/graduate/graduate_reverso/page" passHref legacyBehavior>
          ...
          <li className="step step-warning font-extralight text-xl">
            ...
            <Link href="/graduates_main/graduate_rizo/graduate/graduate_export/page" passHref legacyBehavior>
              <button className=" bg-[#1c004c] text-white btn btn-outline hover:bg-[#ffd700]/90 hover:text-white mt-4">
                Avanzar
                <GrLinkNext size={25} />
              </button>
        ...
        <div className=" flex w-full ">
          ...
          <div className="overflow-x-auto mt-24 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="bg-[#1c004c] border rounded-lg p-10 text-white">
