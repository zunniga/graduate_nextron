...
const imageDB = new NewDataSayan(); // Asegúrate de crear la instancia de la base de datos
...
export default function Home() {
  ...
  return (
    <div className=" min-h-screen bg-[#0d617b]/70  overflow-hidden">
       <IoIosExit
        ...
        <div className=" flex w-full ">
          ...
          <div className="w-[400px]  text-white mt-24 ml-5  rounded-r-xl ">
            <ul className="p-4  border border-slate-200 rounded-xl">
              <li>
                <button
                  className="w-full  text-xl font-futura-bkbt btn bg-[#0d617b] text-[#ffff] hover:bg-[#b6d900]/70 mb-5"
                  onClick={openModal}
                >
                  Agregar manualmente
              ...
              <li>
                <button
                  className="w-full btn text-xl font-futura-bkbt bg-[#0d617b] text-[#ffff] hover:bg-[#b6d900]/70 mb-5"
