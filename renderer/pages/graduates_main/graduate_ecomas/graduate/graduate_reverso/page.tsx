      ...
      <header className="mt-8 text-center mb-10">
        ...
        <ul className="steps   w-full">
          ...
          <li className="step font-extralight text-xl">
            <Link href="/graduates_main/graduate_ecomas/graduate/graduate_export/page" passHref>
              Exportar en PDF
            </Link>
            <Link href="/graduates_main/graduate_ecomas/graduate/graduate_export/page" passHref legacyBehavior>
              <button className=" bg-[#001d51] text-white btn btn-outline hover:bg-[#178617] hover:text-white mt-4">
                Avanzar
                <GrLinkNext size={25} />
              </button>
