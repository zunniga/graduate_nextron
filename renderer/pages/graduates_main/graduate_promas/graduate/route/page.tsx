...
import ReadExcelParticipants from "../../../../../components/graduates/Promas/ReadExcelParticipants";
import CertificateGeneratorExcel from "../../../../../components/graduates/Promas/GraduateGeneratorExcelP";
import CertificateGenerator from "../../../../../components/graduates/Promas/GraduateGeneratorP";
...
const imageDB = new NewDataPromas(); // Asegúrate de crear la instancia de la base de datos
...
export default function Home() {
  ...
  return (
    <div className=" min-h-screen bg-[#7c3aed]/40  overflow-hidden">
       <IoIosExit
      ...
      <header className="mt-8 text-center mb-10">
        ...
        <ul className="steps w-full">
          ...
          <li className="step step-secondary font-extralight text-xl ">
            <Link href="/graduates_main/graduate_promas/graduate/route/page">Insercion de Participantes </Link>
            <Link href="/graduates_main/graduate_promas/graduate/route/page" passHref legacyBehavior>
              <button className=" bg-[#7c3aed]/40 text-white btn btn-outline hover:bg-[#680080] hover:text-white mt-4">
          ...
          <li className="step font-extralight text-xl ">
            <Link href="/graduates_main/graduate_promas/graduate/graduate_reverso/page">Anverso del Diplomado</Link>
          </li>
          <li className="step font-extralight text-xl">
            <Link href="/" passHref>
              Exportar en PDF
            </Link>
            <Link href="/graduates_main/graduate_promas/graduate/graduate_reverso/page" passHref legacyBehavior>
              <button className=" bg-[#7c3aed]/40 text-white btn btn-outline hover:bg-[#ff00d4]/70 hover:text-white mt-4">
                Avanzar
                <GrLinkNext size={25} />
              </button>
            </Link>
        ...
        <div className=" flex w-full ">
          ...
          <div className="w-[400px]  text-white mt-24 ml-5  rounded-r-xl ">
            <ul className="p-4  border border-slate-200 rounded-xl">
              <li>
                <button
                  className="w-full  text-xl font-futura-bkbt btn bg-[#7c3aed]/50 text-[#ffff] hover:bg-[#db2777]/70 mb-5"
                  onClick={openModal}
                >
                  Agregar manualmente
              ...
              <li>
                <button
                  className="w-full btn text-xl font-futura-bkbt bg-[#7c3aed]/50 text-[#ffff] hover:bg-[#db2777]/70 mb-5"
