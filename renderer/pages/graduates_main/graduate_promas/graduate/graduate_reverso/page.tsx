      ...
      <header className="mt-8 text-center mb-10">
        ...
        <ul className="steps   w-full">
          ...
          <li className="step step-secondary font-extralight text-xl ">
            <Link href="/graduates_main/graduate_promas/graduate/route/page">
              Insercion de Participantes{" "}
            </Link>
            <Link
              href="/graduates_main/graduate_promas/graduate/route/page"
              passHref
              legacyBehavior
            >
              <button className=" bg-[#7c3aed]/50 text-white btn btn-outline hover:bg-[#db2777]/70  hover:text-white mt-4">
          ...
          <li className="step step-secondary font-extralight text-xl ">
            <Link href="/graduates_main/graduate_promas/graduate/graduate_reverso/page">
              Anverso del Diplomado
            </Link>
          </li>
          <li className="step font-extralight text-xl">
            <Link
              href="/graduates_main/graduate_promas/graduate/graduate_export/page"
              passHref
            >
              Exportar en PDF
            </Link>
