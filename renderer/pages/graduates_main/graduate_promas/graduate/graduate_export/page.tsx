...
export default function Home() {
  ...
  return (
    <div className="bg-[#7c3aed66] h-screen overflow-hidden">
      <header className="mt-8 text-center">
        ...
        <ul className="steps w-full">
          ...
          <li className="step step-secondary  font-extralight text-xl">
            ...
            <Link href="/graduates_main/graduate_promas/graduate/graduate_export/page" passHref legacyBehavior>
              <button className=" bg-[#7c3aed]/50 text-white btn btn-outline hover:bg-[#db2777]/70  hover:text-white mt-4">
                Avanzar
                <GrLinkNext size={25} />
              </button>
        ...
        <div className=" flex w-full ">
          ...
          <div className="overflow-x-auto mt-24 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="bg-[#7c3aed]/40 border rounded-lg p-10 text-white">
