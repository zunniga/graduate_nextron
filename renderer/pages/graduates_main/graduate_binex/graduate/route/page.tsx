...
import ReadExcelParticipants from "../../../../../components/graduates/Binex/ReadExcelParticipants";
import CertificateGeneratorExcel from "../../../../../components/graduates/Binex/GraduateGeneratorExcelB";
import CertificateGenerator from "../../../../../components/graduates/Binex/GraduateGeneratorB";
...
const imageDB = new NewDataBinex(); // Asegúrate de crear la instancia de la base de datos
...
export default function Home() {
  ...
  const handleLogout = () => {
    ...
    window.location.href = "/graduates_main/graduate_binex/routess/page";
  };

  return (
    <div className=" min-h-screen bg-[#0079bb]  overflow-hidden">
       <IoIosExit
      ...
      <header className="mt-8 text-center mb-10">
        ...
        <ul className="steps w-full">
          ...
          <li className="step step-accent font-extralight text-xl ">
            <Link href="/graduates_main/graduate_binex/graduate/route/page">Insercion de Participantes </Link>
            <Link href="/graduates_main/graduate_binex/graduate/route/page" passHref legacyBehavior>
          ...
          <li className="step font-extralight text-xl ">
            <Link href="/graduates_main/graduate_binex/graduate/graduate_reverso/page">Anverso del Diplomado</Link>
          </li>
          <li className="step font-extralight text-xl">
            <Link href="/" passHref>
              Exportar en PDF
            </Link>
            <Link href="/graduates_main/graduate_binex/graduate/graduate_reverso/page" passHref legacyBehavior>
              <button className=" bg-[#0079bb] text-white btn btn-outline hover:bg-[#039f85] hover:text-white mt-4">
                Avanzar
                <GrLinkNext size={25} />
              </button>
        ...
        <div className=" flex w-full ">
          ...
          <div className="w-[400px]  text-white mt-24 ml-5  rounded-r-xl ">
            <ul className="p-4  border border-slate-200 rounded-xl">
              <li>
                <button
                  className="w-full  text-xl font-futura-bkbt btn bg-[#00dbb8]/60 text-[#ffff] hover:bg-gray-500 mb-5"
                  onClick={openModal}
                >
                  Agregar manualmente
              ...
              <li>
                <button
                  className="w-full btn text-xl font-futura-bkbt bg-[#00dbb8]/60 text-[#fff] hover:bg-gray-500 mb-5"
