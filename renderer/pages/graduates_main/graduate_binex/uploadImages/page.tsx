...
import { useUploader } from "../../../../components/graduates/Binex/ImageBinexDB";
...
export default function Home() {
  ...
  return (
    <main className="bg-[#00507c] flex flex-col items-center justify-center h-screen">
      {/* Botón del icono en la esquina superior derecha */}
      <Link href="/graduates_main/graduate_binex/routess/page">
        <IoIosExit
        ...
        {[0, 1].map((index) => (
          <div key={index} className="mr-10 flex">
            <div className="flex items-end">
              <input
                className="checkbox checkbox-accent checkbox-lg mb-2 mr-1"
                type="checkbox"
            ...
            <label className="form-control w-full max-w-xs">
              <div className="label bg-[#00dbb8]/60 rounded-xl">
      ...
      <Link href="/graduates_main/graduate_binex/routess/page" passHref legacyBehavior>
        <button
          className={`btn text-white bg-gradient-to-b from-[#0079bb] to-[#00dbb8]/20 btn-lg mt-8  ${
