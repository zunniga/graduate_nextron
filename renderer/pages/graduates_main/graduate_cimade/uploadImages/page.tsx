...
import { useUploader } from "../../../../components/graduates/Cimade/ImageCimadeDB";
...
export default function Home() {
  ...
  const handleLogout = () => {
    ...
    window.location.href = "/graduates_main/graduate_cimade/routess/page";
  };
  ...
  return (
    <main className="bg-[#002e79] flex flex-col items-center justify-center h-screen">
        ...
        {[0, 1].map((index) => (
          <div key={index} className="mr-10 flex">
            ...
            <label className="form-control w-full max-w-xs">
              <div className="label bg-[#006eb0]/60 rounded-xl">
      ...
      <Link href="/graduates_main/graduate_cimade/routess/page" passHref legacyBehavior>
        <button
          className={`btn text-white bg-gradient-to-b from-[#006eb0] to-[#ff00d4]/50 btn-lg mt-8  ${
