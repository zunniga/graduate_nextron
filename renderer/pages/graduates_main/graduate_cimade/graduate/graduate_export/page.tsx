...
const imageDB = new NewDataCimade();
...
export default function Home() {
  ...
  return (
    <div className="bg-[#002e79] h-screen overflow-hidden">
      <header className="mt-8 text-center">
        ...
        <ul className="steps w-full">
          ...
          <li className="step step-secondary font-extralight text-xl ">
            <Link href="/graduates_main/graduate_cimade/graduate/route/page">Insercion de Participantes </Link>
            <Link href="/graduates_main/graduate_cimade/graduate/graduate_reverso/page" passHref legacyBehavior>
          ...
          <li className="step step-secondary font-extralight text-xl ">
            <Link href="/graduates_main/graduate_cimade/graduate/graduate_reverso/page">Anverso del Diplomado</Link>
          </li>
          <li className="step step-secondary  font-extralight text-xl">
            <Link href="/" passHref>
              Exportar en PDF
            </Link>
            <Link href="/graduates_main/graduate_cimade/graduate/graduate_export/page" passHref legacyBehavior>
              <button className=" bg-[#002e79] text-white btn btn-outline hover:bg-[#ff00d4]/70 hover:text-white mt-4">
                Avanzar
                <GrLinkNext size={25} />
              </button>
        ...
        <div className=" flex w-full ">
          ...
          <div className="overflow-x-auto mt-24 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="bg-[#002e79] border rounded-lg p-10 text-white">
